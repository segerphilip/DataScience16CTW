"""This file is based on code for use with "Think Stats",
...
def ReadImRecs(dct_file='2002FemPreg.dct', 
                dat_file='2002FemPreg.dat.gz'):
#need a dictionary to map the .dat file to 
    """Reads the NIS 
...
def MakeImMap(df):
    """Make a map from caseid to list of immunization indices.
